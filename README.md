...
**Выбранный столик:** [ОПИШИ В ДВУХ СЛОВАХ КАКОЙ ВЫДЕЛИЛ НА ВИДЕО]

**Полученные метрики (Analytics):**
- **Среднее время задержки (Average Downtime):** `[ВСТАВЬ СЮДА ЦИФРУ ИЗ КОНЦА ТЕРМИНАЛА] сек.`
...
![Проблемное перекрытие]([ВСТАВЬ_ИМЯ_ТВОЕГО_СКРИНШОТА.png_ИЛИ_УДАЛИ_ЭТУ_СТРОКУ])

> **Описание проблемы:** [Опиши, если на скриншоте человек случайно перекрыл стол, но система благодаря Debounce-задержке не сломала стейт]
